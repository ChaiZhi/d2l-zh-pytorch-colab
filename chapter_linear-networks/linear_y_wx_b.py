...
Original file is located at
    https://colab.research.google.com/github/d2l-ai/d2l-zh-pytorch-colab/blob/master/chapter_linear-networks/linear-regression-scratch.ipynb
...
# labels = torch.tensor([[3.0], [4.0], [6.0]])
